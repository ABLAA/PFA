...
class Category extends React.Component{
    ...
    render(){
        ...
        const allCath=cathegories.map((cathegory)=>
            {
                return(<div className="col-5 col-sm-2 mt-4 ">
                            <img  key={cathegory.id} src={cathegory.src} alt="ghjkl" height="100" width="120"/>
                        </div>)
            });
        return(
            <>
            <center><h1 className="mt-5">LES VOITURES NEUVES</h1></center>
            <center><h3>PAR MARQUE</h3></center>
